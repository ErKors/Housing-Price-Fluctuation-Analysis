...
pop2000_2010 <- read.csv(("~/Desktop/Weylandt Project/Population Estimate 2000_2010.csv")) |> 
                filter(SEX == 0) |>
                filter(AGE == 999) |>
...
pop2011_2019 <- read.csv("~/Desktop/Weylandt Project/Population Estimates 2010_2019.csv") |>
...
pop2020_2023 <- read.csv("~/Desktop/Weylandt Project/Population Estimate 2020_2023.csv") |>
...
Zillow <- read.csv("~/Desktop/Weylandt Project/Zillow.csv") |>
...
# Averaging columns horizontally to consolidate values by year 
    monthly_2000 <- grep("X2000", names(Zillow), value = TRUE)
    Zillow$"2000_Yearly_Avg" <- rowMeans(Zillow[monthly_2000], na.rm = TRUE) 
    
    monthly_2001 <- grep("X2001", names(Zillow), value = TRUE)
    Zillow$"2001_Yearly_Avg" <- rowMeans(Zillow[monthly_2001], na.rm = TRUE) 
    
    monthly_2002 <- grep("X2002", names(Zillow), value = TRUE)
    Zillow$"2002_Yearly_Avg" <- rowMeans(Zillow[monthly_2002], na.rm = TRUE) 
    
    monthly_2003 <- grep("X2003", names(Zillow), value = TRUE)
    Zillow$"2003_Yearly_Avg" <- rowMeans(Zillow[monthly_2003], na.rm = TRUE) 
    
    monthly_2004 <- grep("X2004", names(Zillow), value = TRUE)
    Zillow$"2004_Yearly_Avg" <- rowMeans(Zillow[monthly_2004], na.rm = TRUE) 
    
    monthly_2005 <- grep("X2005", names(Zillow), value = TRUE)
    Zillow$"2005_Yearly_Avg" <- rowMeans(Zillow[monthly_2005], na.rm = TRUE) 
    
    monthly_2006 <- grep("X2006", names(Zillow), value = TRUE)
    Zillow$"2006_Yearly_Avg" <- rowMeans(Zillow[monthly_2006], na.rm = TRUE) 
    
    monthly_2007 <- grep("X2007", names(Zillow), value = TRUE)
    Zillow$"2007_Yearly_Avg" <- rowMeans(Zillow[monthly_2007], na.rm = TRUE) 
    
    monthly_2008 <- grep("X2008", names(Zillow), value = TRUE)
    Zillow$"2008_Yearly_Avg" <- rowMeans(Zillow[monthly_2008], na.rm = TRUE) 
    
    monthly_2009 <- grep("X2009", names(Zillow), value = TRUE)
    Zillow$"2009_Yearly_Avg" <- rowMeans(Zillow[monthly_2009], na.rm = TRUE) 
    
    monthly_2010 <- grep("X2010", names(Zillow), value = TRUE)
    Zillow$"2010_Yearly_Avg" <- rowMeans(Zillow[monthly_2010], na.rm = TRUE) 
    
    monthly_2011 <- grep("X2011", names(Zillow), value = TRUE)
    Zillow$"2011_Yearly_Avg" <- rowMeans(Zillow[monthly_2011], na.rm = TRUE) 
    
    monthly_2012 <- grep("X2012", names(Zillow), value = TRUE)
    Zillow$"2012_Yearly_Avg" <- rowMeans(Zillow[monthly_2012], na.rm = TRUE) 
    
    monthly_2013 <- grep("X2013", names(Zillow), value = TRUE)
    Zillow$"2013_Yearly_Avg" <- rowMeans(Zillow[monthly_2013], na.rm = TRUE) 
    
    monthly_2014 <- grep("X2014", names(Zillow), value = TRUE)
    Zillow$"2014_Yearly_Avg" <- rowMeans(Zillow[monthly_2014], na.rm = TRUE) 
    
    monthly_2015 <- grep("X2015", names(Zillow), value = TRUE)
    Zillow$"2015_Yearly_Avg" <- rowMeans(Zillow[monthly_2015], na.rm = TRUE) 
    
    monthly_2016 <- grep("X2016", names(Zillow), value = TRUE)
    Zillow$"2016_Yearly_Avg" <- rowMeans(Zillow[monthly_2016], na.rm = TRUE) 
    
    monthly_2017 <- grep("X2017", names(Zillow), value = TRUE)
    Zillow$"2017_Yearly_Avg" <- rowMeans(Zillow[monthly_2017], na.rm = TRUE) 
    
    monthly_2018 <- grep("X2018", names(Zillow), value = TRUE)
    Zillow$"2018_Yearly_Avg" <- rowMeans(Zillow[monthly_2018], na.rm = TRUE) 
    
    monthly_2019 <- grep("X2019", names(Zillow), value = TRUE)
    Zillow$"2019_Yearly_Avg" <- rowMeans(Zillow[monthly_2019], na.rm = TRUE) 
    
    monthly_2020 <- grep("X2020", names(Zillow), value = TRUE)
    Zillow$"2020_Yearly_Avg" <- rowMeans(Zillow[monthly_2020], na.rm = TRUE) 
    
    monthly_2021 <- grep("X2021", names(Zillow), value = TRUE)
    Zillow$"2021_Yearly_Avg" <- rowMeans(Zillow[monthly_2021], na.rm = TRUE)
    
    monthly_2022 <- grep("X2022", names(Zillow), value = TRUE)
    Zillow$"2022_Yearly_Avg" <- rowMeans(Zillow[monthly_2022], na.rm = TRUE) 
    
    monthly_2023 <- grep("X2023", names(Zillow), value = TRUE)
    Zillow$"2023_Yearly_Avg" <- rowMeans(Zillow[monthly_2023], na.rm = TRUE) 
...
``` {r}
# Imported BEA Data
BEA_unclean <- read_csv('~/Desktop/Weylandt Project/RegionalData.csv', show_col_types = FALSE)
glimpse(BEA_unclean)
...
Northeast_SalesSF <- read_csv('~/Desktop/Weylandt Project/New One Family Houses Sold in Northeast Census Region, Thousands, Seasonally Adjusted Annual Rate .csv', show_col_types = FALSE) |>
...
Midwest_SalesSF <- read_csv('~/Desktop/Weylandt Project/New One Family Houses Sold in Midwest Census Region, Thousands, Seasonally Adjusted Annual Rate.csv', show_col_types = FALSE) |>
...
South_SalesSF <- read_csv("~/Desktop/Weylandt Project/New One Family Houses Sold in South Census Region, Thousands, Seasonally Adjusted Annual Rate .csv", show_col_types = FALSE) |>
                 rename('South'= HSN1FS) |>
                 rename('Year'= DATE) 
...
West_SalesSF <- read_csv('~/Desktop/Weylandt Project/New One Family Houses Sold in West Census Region, Thousands, Seasonally Adjusted Annual Rate .csv', show_col_types = FALSE) |>
                rename('West'= HSN1FW) |>
                rename('Year'= DATE) 
...
```
``` {r}
allRegions_PopEstimates <- read_csv("~/Desktop/Project csv files/allRegions_PopEstimates.csv", show_col_types = FALSE)
allRegions_Zillow <- read_csv("~/Desktop/Project csv files/allRegions_Zillow.csv", show_col_types = FALSE)
...
```
``` {r}
allRegions_SalesSFH <- read_csv("~/Desktop/Project csv files/allRegions_SalesSFH.csv", show_col_types = FALSE)
...
``` {r}
allRegions_Zillow <- read_csv("~/Desktop/Project csv files/allRegions_Zillow.csv", show_col_types = FALSE)
allRegions_DisposableIncome <- read_csv("~/Desktop/Project csv files/allRegions_DisposableIncome.csv", show_col_types = FALSE)
...
``` {r}    
allRegions_Zillow <- read_csv("~/Desktop/Project csv files/allRegions_Zillow.csv", show_col_types = FALSE)
allRegions_ConsumerSpending <- read_csv("~/Desktop/Project csv files/allRegions_ConsumerSpending.csv", show_col_types = FALSE)
...
```
``` {r}
consumerSpending <- read_csv("~/Desktop/Project csv files/allRegions_ConsumerSpending.csv", show_col_types = FALSE)
disposableIncome <- read_csv("~/Desktop/Project csv files/allRegions_DisposableIncome.csv", show_col_types = FALSE)
popEstimates <- read_csv("~/Desktop/Project csv files/allRegions_PopEstimates.csv", show_col_types = FALSE)
salesSFH <- read_csv("~/Desktop/Project csv files/allRegions_SalesSFH.csv", show_col_types = FALSE)
zillowData <- read_csv("~/Desktop/Project csv files/allRegions_Zillow.csv", show_col_types = FALSE)
mortgage15 <- read_csv("~/Desktop/Weylandt Project/MORTGAGE15US.csv", show_col_types = FALSE)
mortgage30 <- read_csv("~/Desktop/Weylandt Project/MORTGAGE30US.csv", show_col_types = FALSE)
unemployment<- read_csv("~/Desktop/Weylandt Project/UNRATE.csv", show_col_types = FALSE)
